...
class TestOpDispatch:
    ...
    def test_protocol_version_advertises_7_and_still_supports_older(self):
        assert PROTOCOL_VERSION == 7
        assert {2, 3, 4, 5, 6}.issubset(SUPPORTED_PROTOCOL_VERSIONS)
        assert 7 in SUPPORTED_PROTOCOL_VERSIONS
